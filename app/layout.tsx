...
export const metadata: Metadata = {
  ...
  description:
    "Sacred technology for communication with angels, divine wisdom, and spiritual transformation.",
  ...
  openGraph: {
    ...
    title: "TEAR - Angelic Contact",
    description:
      "Unlock divine messages through sacred numerology, symbols, and angelic presence.",
  ...
  abstract:
    "A digital sanctuary where numerology, symbols, and divine knowledge unite.",
  appLinks: {
  ...
  return (
    <html lang="en">
      <body>
        ...
        {children}
        <div className="layout-background fixed top-20 z-[-2]" />
        <div className="layout-background-bottom fixed top-0 left-0 z-[-3]" />
      </body>
    </html>
  );
}
