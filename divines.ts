export default [
    ...
    },
    {
        ...
        description:
          "Saitel jest strażnikiem czystości i boskiej przejrzystości. Pomaga tym, którzy poszukują prawdy i pragną oczyścić swój umysł z wątpliwości i iluzji.",
        how_to_connect:
          "Zapal białą świecę i skup się na swoim pytaniu. Powiedz: 'Saitelu, aniele klarowności, usuń mgłę zwątpienia i poprowadź mnie ku prawdzie.'",
